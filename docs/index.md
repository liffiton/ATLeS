...
After the boxes are assembled and the software is installed, run ``fishweb.py`` and point a browser to ``http://[hostname]:8080/``.  As you turn on boxes, they should become visible in the main web interface.
